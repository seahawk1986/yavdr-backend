...
class pam():
    ...
    def authenticate(self, username: str, password: str, service: str='login', encoding: str='utf-8', resetcreds: bool=True):
        ...
        @conv_func
        def my_conv(n_messages: int, messages: list[Any], p_response, app_data):
